...
```bash
bash <(wget -qO- [https://s.v1v1.de/seedbox](https://raw.githubusercontent.com/myp015/PT-Seedbox/refs/heads/main/qb_fb_vertex_installer.sh)) -t -u ptseedbox2026 -p random -c 1024 -v -f
```
...
```bash
bash <(wget -qO- https://raw.githubusercontent.com/myp015/PT-Seedbox/refs/heads/main/qb_fb_vertex_installer.sh) -t -u 用户名 -p 密码 -c 2048 -v -f
```

### 自定义端口

```bash
bash <(wget -qO- https://raw.githubusercontent.com/myp015/PT-Seedbox/refs/heads/main/qb_fb_vertex_installer.sh) -t -u 用户名 -p 密码 -c 2048 -v -f -o
```
*执行后会提示输入各服务端口*
...
```bash
bash <(wget -qO- https://raw.githubusercontent.com/myp015/PT-Seedbox/refs/heads/main/qb_fb_vertex_installer.sh) -t -u 用户名 -p 密码 -c 2048 -v -f -d "data.zip 直链" -k "解压密码(可选)"
```
...
```bash
bash <(wget -qO- https://raw.githubusercontent.com/myp015/PT-Seedbox/refs/heads/main/qb_fb_vertex_installer.sh) --uninstall
```
